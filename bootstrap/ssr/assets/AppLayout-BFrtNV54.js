import { computed, reactive, onMounted, unref, mergeProps, withCtx, renderSlot, useSSRContext, useSlots, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList, useTemplateRef, ref, nextTick, resolveDynamicComponent, withModifiers, provide, toRef, shallowReactive, markRaw, useId, defineComponent, toHandlers, createSlots, isRef, useModel, watchEffect, watch } from "vue";
...
import { t as tv, u as useAppConfig, a as useLocale, _ as _sfc_main$w, o as omit, e as localeContextInjectionKey, i as isArrayOfArray, b as get, f as useColorMode } from "./Icon-Chcm7u9q.js";
import { c as _sfc_main$v, _ as _sfc_main$x, a as _sfc_main$z, p as pickLinkProps, n as _sfc_main$B } from "./Button-DLZCZWnW.js";
import { createSharedComposable, reactivePick, reactiveOmit, createReusableTemplate } from "@vueuse/core";
import { u as useToast, t as toastMaxInjectionKey } from "./useToast-CTuSIf9f.js";
import { u as usePortal, p as portalTargetInjectionKey } from "./usePortal-EQErrF6h.js";
import { _ as _sfc_main$y } from "./Input-DFvIE7JC.js";
import { u as useStoreData } from "./useStoreData-DrTMI0On.js";
import { _ as _sfc_main$A } from "./Separator-CuyFd3xv.js";
import { defu } from "defu";
import { HoverCard, Popover, DropdownMenu } from "reka-ui/namespaced";
import { _ as _sfc_main$C } from "./Checkbox-PZ4-MUog.js";
import { _ as _sfc_main$D } from "./Badge-DqskWDDq.js";
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "border-t border-b border-gray-200/60 bg-gray-50/50 dark:border-white/5 dark:bg-white/2" }, _attrs))}><div class="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-2 gap-4 py-6 lg:grid-cols-4 lg:gap-8"><!--[-->`);
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sm:col-span-2 lg:col-span-4" }, _attrs))}><div class="flex items-center gap-2.5"><div class="grid size-10 place-items-center rounded-xl bg-gray-900 text-white dark:bg-white dark:text-gray-900"><img src="/assets/logo-ogitu-light.webp" class="size-5 dark:hidden" alt="ogitu logo"><img src="/assets/logo-ogitu.webp" class="hidden size-5 dark:block" alt="ogitu logo"></div><span class="text-lg font-bold tracking-tight text-gray-900 dark:text-white">${ssrInterpolate(unref(appName))}</span></div><p class="mt-4 max-w-xs text-sm leading-relaxed text-gray-600 dark:text-gray-400">${ssrInterpolate(unref(storeDescription))}</p><div class="mt-6 max-w-sm"><p class="text-sm font-medium text-gray-900 dark:text-white">Dapatkan promo terbaru</p><p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Diskon eksklusif langsung ke inbox Anda</p><form class="mt-3 flex gap-2">`);
      ...
      if (unref(form).errors.email) {
        _push(`<p class="mt-2 text-xs text-rose-600 dark:text-rose-300">${ssrInterpolate(unref(form).errors.email)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-6 flex items-center gap-1"><!--[-->`);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const modelPageLinks = computed(() => uniqueByTo(footerMainPages.value));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIcon = _sfc_main$w;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lg:col-span-7 lg:col-start-6" }, _attrs))}><div class="${ssrRenderClass([groupsGridClass.value, "grid gap-8"])}"><!--[-->`);
      ssrRenderList(footerGroups.value, (group) => {
        _push(`<div class="flex flex-col gap-4"><div class="relative"><h3 class="text-[11px] font-bold uppercase tracking-[0.2em] text-gray-900 dark:text-white"> Informasi </h3><div class="mt-2 h-0.5 w-4 bg-primary-500 rounded-full"></div></div><ul class="flex flex-col gap-y-2.5"><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(paymentMethods).length) {
        _push(`<div class="border-t border-gray-200/60 pb-8 pt-8 dark:border-white/10"><p class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400"> Metode Pembayaran </p><div class="mt-3 flex flex-wrap items-center gap-3"><!--[-->`);
        ssrRenderList(unref(paymentMethods), (pm) => {
          _push(`<div class="flex items-center justify-center rounded-lg border border-gray-200/60 bg-white px-3 py-2 shadow-sm dark:border-white/10 dark:bg-white/5">`);
          if (pm.logo) {
            _push(`<img${ssrRenderAttr("src", `/storage/${pm.logo}`)}${ssrRenderAttr("alt", pm.display_name || pm.name)} class="h-6 max-w-20 object-contain">`);
          } else {
            _push(`<!--[-->`);
            _push(ssrRenderComponent(_component_UIcon, {
              name: "i-lucide-credit-card",
              class: "mr-1.5 size-4 shrink-0 text-gray-500 dark:text-gray-400"
            }, null, _parent));
            _push(`<span class="text-xs font-medium text-gray-600 dark:text-gray-300">${ssrInterpolate(pm.display_name || pm.name)}</span><!--]-->`);
          }
          _push(`</div>`);
        });
        _push(`<!--]--></div></div>`);
      ...
      if (unref(bottomMainPages).length) {
        _push(`<div class="border-t border-gray-200/60 py-5 dark:border-white/10"><div class="flex flex-wrap items-center gap-x-4 gap-y-2"><!--[-->`);
        ssrRenderList(unref(bottomMainPages), (link) => {
          _push(ssrRenderComponent(_component_ULink, {
            key: link.to,
            to: link.to,
    ...
    const navItems = computed(() => {
      const baseItems = [
        ...
        },
        {
          ...
          activeWhen: (_, path) => path.startsWith("/games")
        }
      ];
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function goToCheckout() {
      ...
      cartSlideoverOpen2.value = false;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="flex items-center gap-2.5"${_scopeId}><div class="grid size-9 place-items-center rounded-xl bg-gray-900 text-white dark:bg-white dark:text-gray-900 shadow-sm"${_scopeId}><img src="/assets/logo-ogitu-light.webp" class="size-4.5 dark:hidden" alt="ogitu logo"${_scopeId}><img src="/assets/logo-ogitu.webp" class="hidden size-4.5 dark:block" alt="ogitu logo"${_scopeId}></div><div class="hidden sm:block text-left leading-tight"${_scopeId}><p class="text-lg font-bold tracking-tight text-gray-900 dark:text-white"${_scopeId}>${ssrInterpolate(__props.appName)}</p><p class="text-[10px] text-gray-400 dark:text-gray-500 font-medium"${_scopeId}>Premium Store </p></div></span>`);
          } else {
            return [
              createVNode("span", { class: "flex items-center gap-2.5" }, [
                createVNode("div", { class: "grid size-9 place-items-center rounded-xl bg-gray-900 text-white dark:bg-white dark:text-gray-900 shadow-sm" }, [
                  createVNode("img", {
                    src: "/assets/logo-ogitu-light.webp",
                    class: "size-4.5 dark:hidden",
                    alt: "ogitu logo"
                  }),
                  createVNode("img", {
                    src: "/assets/logo-ogitu.webp",
      ...
      if (rightUtilityLinks.value.length) {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const { headerTopBarPages, topbarEnabled, topbarMessage, topbarCtaLabel, topbarCtaUrl } = useStoreData();
    const utilityLinks = computed(() => headerTopBarPages.value);
    const hasMessage = computed(() => !!topbarMessage.value);
    const hasCta = computed(() => !!(topbarCtaLabel.value && topbarCtaUrl.value));
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$w;
      const _component_UButton = _sfc_main$x;
      if (unref(topbarEnabled)) {
        ...
        _push(`<span class="min-w-0 truncate">${ssrInterpolate(hasMessage.value ? unref(topbarMessage) : "Selamat datang di toko kami!")}</span></div><div class="hidden items-center gap-1 sm:flex">`);
        if (hasCta.value) {
          _push(ssrRenderComponent(_component_UButton, {
            to: unref(topbarCtaUrl),
            size: "xs",
            color: "primary",
            variant: "soft",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(topbarCtaLabel))}`);
              } else {
                return [
                  createTextVNode(toDisplayString(unref(topbarCtaLabel)), 1)
                ];
              }
            }),
            _: 1
        ...
        if (hasCta.value && utilityLinks.value.length) {
          _push(`<div class="mx-2 h-4 w-px bg-gray-700"></div>`);
        } else {
          _push(`<!---->`);
        }
        if (utilityLinks.value.length) {
          _push(`<div class="flex items-center divide-x divide-gray-700"><!--[-->`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const page = usePage();
    const { isLoggedIn, cartCount, wishlistCount } = useStoreData();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$w;
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white pb-safe backdrop-blur-xl dark:border-white/5 dark:bg-gray-950/80 lg:hidden" }, _attrs))} data-v-8749b800><div class="flex items-center justify-around h-16 px-2" data-v-8749b800><!--[-->`);
      ssrRenderList(navItems.value, (item) => {
        _push(`<!--[-->`);
        if (item.kind === "link") {
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="relative" data-v-8749b800${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: item.icon,
                  class: "size-6"
                }, null, _parent2, _scopeId));
                if ((item.badge ?? 0) > 0) {
                  _push2(`<span class="absolute -right-2 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary-600 px-1 text-[10px] font-bold text-white shadow-sm ring-2 ring-white dark:ring-gray-950" data-v-8749b800${_scopeId}>${ssrInterpolate(item.badge)}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><span class="text-[10px] font-medium leading-none" data-v-8749b800${_scopeId}>${ssrInterpolate(item.label)}</span>`);
                if (isItemActive(item)) {
                  _push2(`<div class="absolute -top-px h-0.5 w-6 rounded-full bg-gray-900 dark:bg-white" data-v-8749b800${_scopeId}></div>`);
                } else {
                  _push2(`<!---->`);
                }
              } else {
          ...
          _push(`<button type="button" class="${ssrRenderClass([[isItemActive(item) ? "text-gray-900 dark:text-white" : "text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"], "relative flex flex-col items-center justify-center flex-1 gap-1 transition-colors duration-200"])}" data-v-8749b800><div class="relative" data-v-8749b800>`);
          _push(ssrRenderComponent(_component_UIcon, {
            name: item.icon,
            class: "size-6"
          }, null, _parent));
          if ((item.badge ?? 0) > 0) {
            _push(`<span class="absolute -right-2 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary-600 px-1 text-[10px] font-bold text-white shadow-sm ring-2 ring-white dark:ring-gray-950" data-v-8749b800>${ssrInterpolate(item.badge)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><span class="text-[10px] font-medium leading-none" data-v-8749b800>${ssrInterpolate(item.label)}</span>`);
          if (isItemActive(item)) {
            _push(`<div class="absolute -top-px h-0.5 w-6 rounded-full bg-gray-900 dark:bg-white" data-v-8749b800></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</button>`);
...
const BottomNavigation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8749b800"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const page = usePage();
    const { appName, storeFavicon, primaryColor, secondaryColor } = useStoreData();
    watchEffect(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UToaster = _sfc_main$r;
      const _component_UButton = _sfc_main$x;
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(storeFavicon)) {
              _push2(`<link rel="icon"${ssrRenderAttr("href", unref(storeFavicon))}${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(storeFavicon) ? (openBlock(), createBlock("link", {
                key: 0,
                rel: "icon",
                href: unref(storeFavicon)
      ...
      _push(ssrRenderComponent(_component_UApp, {
        portal: "#app",
        locale: { messages: { header: { title: "Menu", description: "Navigasi situs" } } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UToaster, null, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_sfc_main$3, { appName: unref(appName) }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_sfc_main$j, { appName: unref(appName) }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(BottomNavigation, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode(_component_UToaster),
              createVNode("div", { class: "relative flex min-h-dvh flex-col" }, [
                ...
                createVNode(_sfc_main$3, { appName: unref(appName) }, null, 8, ["appName"]),
                ...
                createVNode(_sfc_main$j, { appName: unref(appName) }, null, 8, ["appName"]),
