...
class ReportAnalyticBonusPlanATableWidget extends ReportAnalyticTableWidget
{
    public function table(Table $table): Table
    {
        $plan = $this->summary()['bonus_summary']['planA'];

        return $this->configureSummaryTable($table)
            ->heading('Summary Bonus Plan A')
            ->description(sprintf(
                'Network Builder Plan dengan total bonus %s dan payout %s.',
